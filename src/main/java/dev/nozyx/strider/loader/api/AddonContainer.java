...
/**
 * Represents an addon and its associated metadata and JAR path.
 *
 * @param info the addon's metadata
 * @param jarPath the path to the addon's JAR file
 */
public record AddonContainer(AddonInfo info, Path jarPath) {}
